...
.border {
  border: 1px solid #97afd1 !important;
}
...
#gif-background {
  position: fixed;
        ...
        width: 100%;
        height: 100%;
        z-index: -1; /* Para colocar el gif detrás del contenido */
        opacity: 0.85; /* Ajustar la opacidad según sea necesario */
        }
